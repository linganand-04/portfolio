...
export const education = [
  {
    ...
    institution: "Loganatha Narayanasamy Government College",
    period: "2022 — 2025",
    description:
      "Built a foundation in computer science fundamentals and started self-learning frontend web development.",
  },
  {
    id: "edu-2",
    degree: "Master of Computer Applications (MCA)",
    institution: "University of Madras (Distanct Eductation)",
    period: "2025 — 2027 (Ongoing)",
    description:
      "Focused on advanced programming, software engineering practices, and full-stack web development.",
  },
];
